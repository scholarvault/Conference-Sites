/**
 * SVRIDS 2027 - Academic Enrichment & Localization Engine
...
(function () {
  ...
  const SUMMIT_EVENT = {
    title: 'ScholarVault Research-to-Impact, DeepTech & Startup Summit 2027 (SVRIDS 2027)',
    startUtc: '20270115T033000Z', // 09:00 IST Jan 15
    endUtc: '20270116T123000Z',   // 18:00 IST Jan 16
    startIso: '2027-01-15T03:30:00Z',
    endIso: '2027-01-16T12:30:00Z',
    location: 'Hybrid: Innovation Hub Stage, Bengaluru + Global Virtual • ScholarVault Conferences',
    details: 'ScholarVault Research-to-Impact, DeepTech & Startup Summit 2027 (SVRIDS 2027).\n\nKeynote lectures, track presentation stages, and peer-review benchmarks.\nOfficial Site: https://deeptech.scholarvault.in'
  };

  const DEADLINE_EVENT = {
    title: 'SVRIDS 2027 - Abstract & Pitch Submission Deadline',
    startUtc: '20261210T182959Z',
    endUtc: '20261210T182959Z',
    startIso: '2026-12-10T18:29:59Z',
    endIso: '2026-12-10T18:29:59Z',
    location: 'https://deeptech.scholarvault.in/submit-paper.html',
    details: 'Final deadline to submit abstracts and pitches to SVRIDS 2027 across 6 thematic tracks.\nSubmit online: https://deeptech.scholarvault.in/submit-paper.html'
  };
  ...
  function createCalendarDropdownWidget() {
    ...
    wrap.innerHTML = `
      ...
      <div class="calendar-dropdown-menu" role="menu">
        <div class="calendar-menu-header">15–16 Jan 2027 • Summit Days</div>
        ...
        <div class="calendar-menu-header" style="margin-top: 6px;">10 Dec 2026 • Pitch Deadline</div>
